...
from ..helpers import get_unique_embedder_keys_from_conditioner, pangu_get_batch
import numpy as np
...
class DiffusionEngine(pl.LightningModule):
    ...
    def pangu_do_sample(
        ...
        randn = torch.tensor(np.random.randn(*shape), dtype=torch.float,device="cuda")
    ...
    def pangu_decode_first_stage(self,z):
        """
